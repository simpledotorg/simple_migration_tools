...
CREATE TABLE IF NOT EXISTS public.blood_sugars (
    id uuid DEFAULT public.gen_random_uuid() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.bsnl_delivery_details (
    id bigint NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.bsnl_delivery_details_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE SEQUENCE IF NOT EXISTS public.call_logs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS public.clean_medicine_to_dosages (
...
CREATE TABLE IF NOT EXISTS public.deduplication_logs (
    id uuid DEFAULT public.gen_random_uuid() NOT NULL,
    user_id uuid,
...
CREATE TABLE IF NOT EXISTS public.drug_stocks (
    id uuid DEFAULT public.gen_random_uuid() NOT NULL,
    facility_id uuid,
    user_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.email_authentications (
    id uuid DEFAULT public.gen_random_uuid() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.estimated_populations (
    id uuid DEFAULT public.gen_random_uuid() NOT NULL,
    region_id uuid NOT NULL,
    population integer,
...
CREATE TABLE IF NOT EXISTS public.exotel_phone_number_details (
    id uuid DEFAULT public.gen_random_uuid() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.facilities_teleconsultation_medical_officers (
    facility_id uuid NOT NULL,
    user_id uuid NOT NULL
);
...
CREATE TABLE IF NOT EXISTS public.facility_business_identifiers (
    id bigint NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.facility_business_identifiers_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS public.flipper_features (
    id bigint NOT NULL,
    key character varying NOT NULL,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL
...
CREATE SEQUENCE IF NOT EXISTS public.flipper_features_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS public.flipper_gates (
    id bigint NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.flipper_gates_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS public.patient_business_identifiers (
    id uuid DEFAULT public.gen_random_uuid() NOT NULL,
    identifier character varying NOT NULL,
    identifier_type character varying NOT NULL,
    patient_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.patient_phone_numbers (
    id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.medicine_purposes (
    name character varying NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.observations_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS public.passport_authentications (
    id bigint NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.passport_authentications_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS public.patient_attributes (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    height numeric,
    weight numeric,
    patient_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.phone_number_authentications (
    id uuid DEFAULT public.gen_random_uuid() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.protocol_drugs (
    id uuid NOT NULL,
    name character varying NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.raw_to_clean_medicines (
...
CREATE TABLE IF NOT EXISTS public.treatment_group_memberships (
    id bigint NOT NULL,
    treatment_group_id uuid NOT NULL,
    patient_id uuid NOT NULL,
    created_at timestamp without time zone NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.treatment_group_memberships_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS public.twilio_sms_delivery_details (
    id bigint NOT NULL,
    session_id character varying,
    result character varying,
    callee_phone_number character varying NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.twilio_sms_delivery_details_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: reporting_patient_states_on_org_slug; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX reporting_patient_states_on_org_slug ON public.reporting_patient_states USING btree (assigned_organization_slug);
...
-- Refresh Mat views
REFRESH MATERIALIZED VIEW public.latest_blood_pressures_per_patient_per_months;
REFRESH MATERIALIZED VIEW public.latest_blood_pressures_per_patients;
REFRESH MATERIALIZED VIEW public.blood_pressures_per_facility_per_days;
REFRESH MATERIALIZED VIEW public.materialized_patient_summaries;
REFRESH MATERIALIZED VIEW public.reporting_patient_blood_pressures;
REFRESH MATERIALIZED VIEW public.reporting_patient_blood_sugars;
REFRESH MATERIALIZED VIEW public.reporting_overdue_calls;
REFRESH MATERIALIZED VIEW public.reporting_patient_visits;
REFRESH MATERIALIZED VIEW public.reporting_prescriptions;
REFRESH MATERIALIZED VIEW public.reporting_patient_follow_ups;
REFRESH MATERIALIZED VIEW public.reporting_patient_states;
REFRESH MATERIALIZED VIEW public.reporting_facility_appointment_scheduled_days;
REFRESH MATERIALIZED VIEW public.reporting_overdue_patients;
REFRESH MATERIALIZED VIEW public.reporting_facility_states;
REFRESH MATERIALIZED VIEW public.reporting_quarterly_facility_states;
REFRESH MATERIALIZED VIEW public.reporting_facility_daily_follow_ups_and_registrations;
REFRESH MATERIALIZED VIEW public.reporting_facility_monthly_follow_ups_and_registrations;
